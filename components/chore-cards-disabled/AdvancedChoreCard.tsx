...
// Temporarily commented out until components are fixed
...
const AdvancedChoreCard: React.FC<Props> = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Certification Status - temporarily disabled */}
      ...
      {expandedCard && (
        <View style={styles.expandedContent}>
          ...
          {/* Educational Content - temporarily disabled */}
          {/* <EducationalContent 
          ...
          {/* Quality Rating Input (when completing) - temporarily disabled */}
          {/* {isCompleting && (
            <QualityRatingInput 
      ...
      {/* Instruction Modal - temporarily disabled */}
      ...
      {/* Performance History Modal - temporarily disabled */}
      {/* {showPerformance && (
        <PerformanceHistory 
          choreId={chore.id!}
          userId={currentUserId}
